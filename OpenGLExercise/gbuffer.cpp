...
GBuffer::~GBuffer()
{
    ...
    if (m_textures[0] != 0) {
        gl->glDeleteTextures(ARRAY_SIZE_IN_ELEMENTS(m_textures), m_textures);
    }
...
bool GBuffer::Init(unsigned int WindowWidth, unsigned int WindowHeight)
{
    ...
    gl->glGenTextures(ARRAY_SIZE_IN_ELEMENTS(m_textures), m_textures);
    ...
    gl->glDrawBuffers(ARRAY_SIZE_IN_ELEMENTS(DrawBuffers), DrawBuffers);
